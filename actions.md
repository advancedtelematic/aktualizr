...
- [x] aktualizr has an OSTree package manager (packagemanagerfactory_test.cc, ostreemanager_test.cc)
...
- [x] aktualizr can load and store a list of installed versions (uptane_test.cc)
