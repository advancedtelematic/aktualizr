...
const crypto_key_t device_public_key = {
  ...
  .keyid = {0x13, 0xf6, 0x59, 0xbb, 0xe5, 0x9f, 0xdf, 0xfb, 0xed, 0xae, 0x16, 0xd9, 0x63, 0x69, 0xf4, 0x59, 0x24, 0x8c, 0x21, 0x70, 0x59, 0x78, 0x3f, 0x04, 0x25, 0xf5, 0xf4, 0x31, 0x93, 0xf3, 0xde, 0xcf}, 
  .keyval = {0xF6, 0x59, 0xF7, 0x02, 0xCC, 0xD2, 0x1F, 0x4F, 0x6F, 0xA8, 0x7B, 0x88, 0x51, 0x1E, 0x2F, 0x9C, 0xD8, 0x5F, 0x6C, 0xF6, 0x95, 0x11, 0x4D, 0x29, 0x98, 0x9B, 0x1F, 0x0F, 0xE8, 0x86, 0xB3, 0x55},
};

const uint8_t device_private_key[] = {0x36, 0x5D, 0xF7, 0x1A, 0xEA, 0x71, 0x61, 0xCC, 0x58, 0x57, 0xF4, 0x03, 0xE1, 0xE6, 0x1E, 0xBB, 0x54, 0xFD, 0x89, 0x09, 0xF9, 0xA5, 0xA1, 0x39, 0xDF, 0x86, 0xE5, 0xAF, 0xA9, 0x3F, 0x24, 0x4C};
...
void state_set_targets(const uptane_targets_t* targets) {
  memcpy(&stored_targets, targets, sizeof(uptane_targets_t));
}
