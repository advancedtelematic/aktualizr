 ...
 * @param out Pointer to the buffer for encoded data. Data is zero-terminated, the buffer should be at least
 * BASE64_ENCODED_BUF_SIZE(msg_len) bytes large
 */
 ...
 * @param out Pointer to the buffer for decoded data. The buffer should be at least
 * BASE64_DECODED_BUF_SIZE(strlen(base64)) bytes large
