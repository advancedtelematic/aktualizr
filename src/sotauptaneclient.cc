...
Json::Value SotaUptaneClient::getJSON(SotaUptaneClient::ServiceType service, const std::string &role, bool force_fetch) {
...
bool SotaUptaneClient::verify(SotaUptaneClient::ServiceType service, const std::string &role, SotaUptaneClient::Verified &verified,
                    bool force_fetch) {
...
bool SotaUptaneClient::verifyData(SotaUptaneClient::ServiceType service, const std::string &role, const Json::Value &tuf_signed) {
...
void SotaUptaneClient::putManfiest(SotaUptaneClient::ServiceType service) {
  ...
  for (std::vector<Json::Value>::iterator it = ecu_versions.begin(); it != ecu_versions.end(); ++it) {
    ...
    version_manifest.append(ecu_version_signed);
  }
...
bool SotaUptaneClient::ecuRegister() {
  ...
  std::string data = "{\"primary_ecu_serial\":\"" + config.uptane.primary_ecu_serial +
                     "\", \"ecus\":[{\"ecu_serial\":\"" + config.provision.device_id +
