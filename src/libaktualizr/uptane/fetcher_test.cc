...
static const int pause_duration = 10;  // seconds
// 100 MB file / 4 Mbit/s = 200 sec
...
// TODO: quite annoying behavior of the Config constructor,
// which resets previously set loglevel to ::info
Config config;
...
void test_pause(const Uptane::Target& target) {
  ...
  std::cerr << "Downloaded 100 MB in " << duration - pause_duration << " seconds\n";
