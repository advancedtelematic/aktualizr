...
void ymlcfg_readFile(const std::string& filename)
{
   ...
   {
      LOGGER_LOG(LVL_debug, "ymlcfg - no server URL found in config file: " << filename);
   }
   ...
   {
      LOGGER_LOG(LVL_debug, "ymlcfg - no clientID found in config file: " << filename);
   }
   ...
   {
      LOGGER_LOG(LVL_debug, "ymlcfg - no client-secret found in config file: " << filename);
   }
   ...
   {
      LOGGER_LOG(LVL_debug, "ymlcfg - no loglecvel found in config file:" << filename);
   }
