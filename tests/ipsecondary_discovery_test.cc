...
TEST(ipsecondary_discovery, test_discovery) {
  ...
  EXPECT_EQ(secondaries[0].ecu_serial, std::string("test_ecu"));
  EXPECT_EQ(secondaries[0].ecu_hardware_id, std::string("test_hardware_id"));
  EXPECT_EQ(secondaries[1].ecu_serial, std::string("test_ecu2"));
  EXPECT_EQ(secondaries[1].ecu_hardware_id, std::string("test_hardware_id2"));
}
