...
By default, without any commandline arguments this utility displays all information without metadata.
But metadata output also supported with special arguments:
