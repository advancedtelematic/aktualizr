...
. The metadata is cryptographically checked for validity following the https://uptane.github.io[Uptane] https://uptane.org/docs/latest/standard/uptane-standard[specification].
