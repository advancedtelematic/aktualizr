...
| `curl_proxy`                |                | Proxy to use. Initialize libcurl based  http client with  https://curl.se/libcurl/c/CURLOPT_PROXY.html[CURLOPT_PROXY]. For string format see documentation on https://curl.se/libcurl/c/CURLOPT_PROXY.html[CURLOPT_PROXY]
|==========================================================================================
