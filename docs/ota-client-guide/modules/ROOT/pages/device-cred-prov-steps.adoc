...
Learn how provisioning in production is different from the provisioning method that you used to get started. You'll also understand the major steps involved in provisioning devices for production.
...
* *xref:install-device-certs.adoc[Install your device certificates on devices]*
+
