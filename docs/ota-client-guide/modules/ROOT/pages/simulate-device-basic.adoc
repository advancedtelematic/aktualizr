...
The first step is to install an aktualizr binary on your system. You can install packages for Ubuntu 16.04, or Ubuntu 18.04. If you use a different system, you will need to build from source.
