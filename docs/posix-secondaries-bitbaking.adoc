...
....
sudo ../meta-updater/scripts/run-qemu-ota --no-gui --secondary-network primary-image
....
...
....
sudo ../meta-updater/scripts/run-qemu-ota --no-gui --secondary-network secondary-image
....
