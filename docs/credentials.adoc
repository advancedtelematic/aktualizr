...
| autoprov_credentials.p12 | TLS client credentials for automatic device provisioning | aktualizr, aktualizr-cert-provider
| autoprov.url | URL for automatic provisioning server | aktualizr, aktualizr-cert-provider
