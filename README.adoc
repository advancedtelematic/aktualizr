...
On a Mac, building aktualizr with a link:https://brew.sh[brew] package manager
standard installation is partially supported. You can install the necessary dependencies
