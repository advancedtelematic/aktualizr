...
Building the aktualizr branch with gRPC support will require you to install gRPC binaries and supporting development headers on your machine. The binary distribution lacks the necessary CMake macros, so a source build is required.
See how to build and install gRPC here: https://github.com/grpc/grpc/blob/master/BUILDING.md
